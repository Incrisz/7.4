<div class="text-left">
    ...
    @if ($detailedProduct->brand != null)
        <div class="d-flex flex-wrap align-items-center mb-3">
            <span class="text-secondary fs-14 fw-400 mr-4 w-50px">{{ translate('Location') }}</span><br>
...
<br>
    ...
    <div class="d-flex flex-wrap align-items-center">
        <div class="d-flex align-items-center mr-3">
            <!-- Shop Name -->
            @if ($detailedProduct->external_link)
                <span class="text-secondary fs-14 fw-400 mr-4 ">{{ translate('Contact : ') }}</span>
                <a href="{{ route('shop.visit', $detailedProduct->user->shop->slug) }}"
                    class="text-reset hov-text-primary fs-14 fw-700">{{ $detailedProduct->external_link }}</a>
    ...
    <!-- Without auction product -->
        ...
        <!-- Without Wholesale -->
            ...
            @else
            @if($detailedProduct->external_link_btn == 'services')
            <div class="row no-gutters mb-3">
                    <div class="col-sm-2">
                        <div class="text-secondary fs-14 fw-400">{{ translate('Price') }}</div>
                    </div>
