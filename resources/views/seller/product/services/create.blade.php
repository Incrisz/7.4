    ...
    <form class="" action="{{ route('seller.products.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="row gutters-5">
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Service Name') }}</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="name"
                                    placeholder="{{ translate('Skill Name') }}" onchange="update_sku()" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" id="brand" >
                            <label class="col-md-3 col-from-label">{{ translate('School') }}</label>
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="brand_id" id="brand_id"
                                    data-live-search="true">
                                    <option value="">{{ translate('Select School') }}</option>
                            ...
                            <div class="form-group row" style="display: none;">
                                ...
                                <div class="col-md-8">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="refundable"  value="0">
                                        <span></span>
                                    </label>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{ translate('Services Images') }}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{ translate('Services price ') }}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Services price') }}</label>
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="0" step="0.01"
                                    placeholder="{{ translate('Service price') }}" name="unit_price" class="form-control"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row"  >
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="{{ translate('e.g. 0801234567') }}"
                        ...
                        <div class="form-group row" style="display: none;" >
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="{{ translate('External link button text') }}"
                                    name="external_link_btn" value="services" class="form-control">
                                <small
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{ translate('Services Description') }}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
