...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/delivery/login', 'login')->name('deliveryboy.login');
    ...
    Route::get('/schools', 'all_brands')->name('brands.all');
...
Route::controller(SearchController::class)->group(function () {
    ...
    Route::get('/school/{brand_slug}', 'listingByBrand')->name('products.brand');
});
